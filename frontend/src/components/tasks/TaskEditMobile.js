...
import { Grid, Icon, Header, Segment, Dropdown, Button } from 'semantic-ui-react'
...
function TaskEditMobile({ formData, task, date, selectDropdown, handleChange, handleDateChange, deleteItem }) {
